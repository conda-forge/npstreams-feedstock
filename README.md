About npstreams-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/npstreams-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4516&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/npstreams-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `npstreams` can be installed with `conda`:
...
```
mamba install npstreams
```

It is possible to list all of the versions of `npstreams` available on your platform with `conda`:
...
```
mamba search npstreams --channel conda-forge
```
...
mamba repoquery search npstreams --channel conda-forge

# List packages depending on `npstreams`:
mamba repoquery whoneeds npstreams --channel conda-forge

# List dependencies of `npstreams`:
mamba repoquery depends npstreams --channel conda-forge
```
